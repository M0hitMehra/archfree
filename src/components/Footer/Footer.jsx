    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-around py-8 md:py-14">
        <div className="flex flex-col mt-6 mb-8 md:mt-14 md:mb-0">
          ...
          <p className="text-white mt-4">Email: info@thearchertechnology.com</p>
        </div>

        <div className="flex flex-col mt-6 mb-8 md:mt-14 md:mb-0">
          <h1 className="text-white text-lg md:text-2xl font-bold">Quick Links</h1>
        ...
        <div className="flex flex-col mt-6 mb-8 md:mt-14 md:mb-0">
          <h1 className="text-white text-lg md:text-2xl font-bold">Our Services</h1>
          <p className="text-white mt-4 hover:text-yellow-400 cursor-pointer">
            <IoLogoFacebook className="text-xl md:text-2xl text-white mr-2 inline" />
            Web Development
          </p>
        ...
        <div className="flex flex-col mt-6 mb-8 md:mt-14 md:mb-0">
          <h1 className="text-white text-lg md:text-2xl font-bold">Social Media</h1>
